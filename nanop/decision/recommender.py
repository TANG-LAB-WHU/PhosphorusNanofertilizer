...
from nanop.decision.criteria import CriteriaSet, create_default_criteria
from nanop.decision.mcda import TOPSIS, WeightedSum, MCDAResult
from nanop.decision.pareto import ParetoAnalyzer
from nanop.decision.scenario import ScenarioAnalyzer
...
class PathwayRanker:
    ...
    def _adjust_category_weights(
        ...
        from nanop.decision.criteria import Category
