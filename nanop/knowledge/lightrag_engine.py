...
Graph-enhanced Retrieval Augmented Generation engine for Phosphorus Nanofertilizer literature.
        ...
        try:
            ...
            response = client.chat.completions.create(
                ...
                messages=[{
                    "role": "user",
                    "content": [
                        {"type": "text", "text": "This image is from a scientific paper about Phosphorus Nanofertilizer. Describe it in detail (flowcharts, charts, tables). English only."},
