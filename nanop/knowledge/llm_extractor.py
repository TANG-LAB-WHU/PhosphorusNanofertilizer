...
EXTRACTION_PROMPTS = {
    "composition": """
Extract Phosphorus Nanofertilizer composition data from the text.
        ...
        try:
            ...
            if self.provider == "gemini":
                ...
                response = client.chat.completions.create(
                    model=self.model,
                    messages=[
                        {"role": "system", "content": "You are a data extraction assistant specialized in Life Cycle Assessment and Techno-Economic Analysis of Phosphorus Nanofertilizer treatment. Extract structured data accurately."},
