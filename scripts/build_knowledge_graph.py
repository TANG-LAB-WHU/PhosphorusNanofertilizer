"""
This script processes PDF papers and builds a knowledge graph for nanoPfertilizer-LCA-TEA.
...
try:
    from nanop.knowledge import RAGAnythingEngine, RAGANYTHING_AVAILABLE
except ImportError:
...
def run_pipeline(steps: list, parser_type: str = "pymupdf", limit: int = None, engine: str = "lightrag"):
    ...
    print("\n" + "=" * 60)
    print("   nanoPfertilizer-LCA-TEA KNOWLEDGE GRAPH PIPELINE")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(
        description="Build Knowledge Graph from Phosphorus Nanofertilizer Literature"
    )
    parser.add_argument(
        "--step",
