...
This directory contains utility scripts for building and managing the nanoPfertilizer-LCA-TEA knowledge base.

---

## `build_knowledge_graph.py`

Main pipeline script for processing Phosphorus Nanofertilizer literature and building the knowledge graph.
